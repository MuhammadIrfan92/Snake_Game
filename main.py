...
BODY_PARTS = 3  # HOW MANY BODY PARTS SNAKE HAS AT THE START
SNAKE_COLOR = "#CCFF00"
FOOD_COLOR = "#FF0000"
...
def check_collisions(snake):
    x, y = snake.coordinates[0]  # coordinates of head of snake
    if x < 0 or x >= GAME_WIDTH:
        return True
    elif y < 0 or y >= GAME_HEIGHT:
        return True

    for body_part in snake.coordinates[1:]:  # everything after head
...
def game_over():
    ...
    canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2,
                       font=('consoles', 70), text="GAME OVER", fill='red', tag='game_over')
